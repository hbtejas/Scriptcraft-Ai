...
import { generateScript, summarizeScript, generateQuiz } from '../services/aiService'
...
const Generator = () => {
  ...
  const tones = [
    { value: 'conversational', label: 'Conversational', desc: 'Casual and friendly' },
  ...
  const handleGenerateScript = async () => {
    ...
    const { data, error } = await generateScript(formData.prompt, formData.tone)
    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-dark-300">Let AI help you craft the perfect podcast script</p>
        </motion.div>
        ...
        {step === 1 && (
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-3">Choose a Tone</label>
            ...
            <div className="card">
              ...
              {generatedData.quiz ? (
                <div className="space-y-4">
                  {Array.isArray(generatedData.quiz) && generatedData.quiz.map((question, index) => (
                ...
                <p className="text-dark-400 text-center py-8">
                  Click "Generate Quiz" to create quiz questions from your script
                </p>
              )}
            </div>
